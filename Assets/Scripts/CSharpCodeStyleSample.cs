...
// |[General]
// |    - Our standard extends Unity and  Microsoft's Framework Design Guidelines, which defines a number of rules not covered by this document. (see https://docs.microsoft.com/en-us/dotnet/standard/design-guidelines/).
...
using System.IO;
using System.Linq;
using UnityEngine;    // | Start of non-System group

using Component = UnityEngine.Component;  // | Start of aliases group
using Debug = UnityEngine.Debug;

namespace StansAssets.ProjectSample   // | Full contents of namespace indented
{
    // |[Enums]
